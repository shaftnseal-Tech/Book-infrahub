...
const Productpage = () => {
  ...
  const handleLeftArrowClick = () => {
    setPrimaryImageIndex((prevIndex) =>
  ...
  const handleRightArrowClick = () => {
    setPrimaryImageIndex((prevIndex) =>
      prevIndex === extraImages.length - 1 ? 0 : prevIndex + 1
    );
  };
      ...
      <Box>
        ...
        <Grid container spacing={3} className="product-page-content">
          ...
          >
            ...
            {/* Extra Images Sliver : NOT COMPLETED*/}
            <Grid
              container
              spacing={1}
              sx={{
          ...
          <Grid xs={12} md={6}>
              ...
              <Grid container spacing={2} className="product-details-container">
                ...
                <Grid item xs={12} md={6}>
                  <Typography variant="body2" sx={{ marginTop: 2 }}>
                    ...
                    <strong>{product[0].Sku}</strong>
                  </Typography>
                  <Typography variant="body2">
                    <span className="productpage-light-text">Brand:</span>{" "}
                    <strong>{product[0].Brand}</strong>
                  </Typography>
                  <Typography variant="body2">
                    <span className="productpage-light-text">Mode:</span>{" "}
                    {product[0].Mode.map((mode, index) => (
                      <strong
                        key={index}
                        style={{
                          color: mode === "Online" ? "#00B61B" : "inherit",
                          marginRight: index < product[0].Mode.length - 1 ? "10px" : "10px",
                        }}
                      >
                        {mode}
                      </strong>
                ...
                <Grid item xs={12} md={6}>
                  <Typography variant="body2" sx={{ marginTop: 2 }}>
                    ...
                    <strong>
                      <span
                        style={{
                          color: Availaility === "In Stock" ? "#00B61B" : "red",
                        }}
                      >
                        {Availaility}
                      </span>
              ...
              <Grid>
                ...
                <div className="delivery-container">
                  <Grid container className="section-heading">
                    <Grid item xs={6} md={2}>
                      <Typography
                        className="delivery_highlight_desc"
                        variant="h6"
                      >
                        Delivery
                      </Typography>
            ...
            >
              <Grid>
                <Grid
                  container
                  alignItems="center"
                  className="rating_review_head_section"
                >
                ...
                <Grid container alignItems="center">
                  <Grid item xs className="read_all_review">
                    <Typography variant="body1" className="read_all_button">
                      Read All Reviews
                    </Typography>
                  </Grid>
            ...
            >
              ...
              <Box className="qsn_ans_section_2">
                {qaData.map((item) => (
                  <Card key={item.id} sx={{ borderBottom: "0.5px solid #E4E7E9" }} style={{
                    "--Paper-shadow": `0px 2px 1px -1px rgba(0, 0, 0, 0),
                       0px 1px 1px 0px rgba(0, 0, 0, 0),
                       0px 1px 3px 0px rgba(0, 0, 0, 0)`
                  }}>
                    <CardContent
                      sx={{ marginTop: 2, marginLeft: 2, marginRight: 4 }}
                    >
              ...
              <Grid container alignItems="center">
                ...
                <Grid item className="plush_product_review"></Grid>
              </Grid>
            </Grid>
          </Grid>
        </Grid>
